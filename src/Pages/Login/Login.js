...
<div className="w-full max-w-md p-8 space-y-3 rounded-xl shadow-xl shadow-violet-900 textColor purple">
	...
	<form onSubmit={handleSubmit} novalidate="" action="" className="space-y-6 ng-untouched ng-pristine ng-valid">
		...
		<button className="block w-full p-3 text-center btn-primary rounded-md ">Sign in</button>
	</form>
	...
	<p className="text-xs text-center sm:px-6">Don't have an account?
		<Link rel="noopener noreferrer" to={'/register'} className="underline text-gray-300 text-lg font-bold ">Sign up</Link>
	</p>
    <div className="flex items-center pt-4 space-x-1">
		<div className="flex-1 h-px sm:w-16 bg-gray-800"></div>
